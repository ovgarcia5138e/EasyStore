...
class RequestSpaceController : UIViewController {
    //MARK: - Properties
...
extension RequestSpaceController : UIPickerViewAccessibilityDelegate, UIPickerViewDataSource {
...
extension RequestSpaceController : UIImagePickerControllerDelegate, UINavigationControllerDelegate {
